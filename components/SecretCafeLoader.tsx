...
export function SecretCafeLoader({
  ...
  return (
    ...
    >
      <div
        className="pointer-events-none absolute left-1/2 top-1/3 h-130 w-130 -translate-x-1/2 -translate-y-1/2 rounded-full blur-3xl"
        style={{
          background:
      ...
      <div className="relative flex flex-col items-center">
        <div className="relative mb-3 flex h-20 w-24 items-end justify-center gap-2">
          {[0, 1, 2].map((i) => (
            <span
              key={i}
              className="block h-16 w-1.5 rounded-full bg-linear-to-t from-transparent via-amber-100/40 to-transparent blur-[2px]"
              style={{
        ...
        <div className="mt-8 h-0.5 w-56 overflow-hidden rounded-full bg-amber-200/10">
          <div
            className="h-full w-1/3 rounded-full bg-linear-to-r from-transparent via-amber-300 to-transparent"
